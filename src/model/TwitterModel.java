...
public class TwitterModel {
    ...
    public void tweetStatus(String tweet){
        try {
            ...
            JOptionPane.showMessageDialog(null, "error @tweetStatus "+ ex);
        }
    }
    ...
    public String getHomeTimeline(){
        try {
            ...
            JOptionPane.showMessageDialog(null, "error @getHomeTimeline " + ex);
            return null;
        }
    }
    ...
    public void followUser(String user){
        try {
            ...
            JOptionPane.showMessageDialog(null, "error @followuser "+  ex);
        }
